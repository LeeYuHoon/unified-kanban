...
_compatibility_check = check_hermes_compatibility
...
def _on_pre_llm_call(**kwargs):
    ...
    try:
        ...
        logger.warning("Hermes Kanban turn start failed: %s", exc)
    return None
...
def _on_post_tool_call(**kwargs):
    ...
    try:
        ...
        logger.warning("Hermes Kanban tool usage record failed: %s", exc)
    return None
...
def _on_subagent_start(**kwargs):
    ...
    try:
        ...
        logger.warning("Hermes Kanban subagent record failed: %s", exc)
    return None
...
def _on_post_llm_call(**kwargs):
    ...
    try:
        ...
        logger.warning("Hermes Kanban turn result record failed: %s", exc)
    return None
...
def _on_post_api_request(**kwargs):
    ...
    try:
        ...
        logger.warning("Hermes Kanban token usage record failed: %s", exc)
    return None
...
def _on_session_end(**kwargs):
    ...
    try:
        ...
        logger.warning("Hermes Kanban turn completion failed: %s", exc)
    return None
